...
const WhyCourse = () => {
  return (
    <div className=" flex flex-col justify-center items-center mt-8">
      <h1 className="text-4xl font-bold">Why CareerGuide Course</h1>
      ...
      <div className="flex flex-row gap-10">
        ...
        <div className="flex w-[25rem] gap-5 flex-col justify-center items-center border rounded-xl shadow-lg">
